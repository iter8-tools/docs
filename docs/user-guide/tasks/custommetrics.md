...
Example providers specs:
  * [istio-prom](https://raw.githubusercontent.com/iter8-tools/iter8/v0.12.0/testdata/custommetrics/istio-prom.tpl) for [Istio's Prometheus plugin](https://istio.io/latest/docs/ops/integrations/prometheus/)
