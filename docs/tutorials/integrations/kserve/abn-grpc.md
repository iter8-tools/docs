...
This tutorial describes how to do A/B testing as part of the release of a backend ML model hosted on [KServe](https://github.com/kserve/kserve) using the [Iter8 SDK](../../../user-guide/abn/about.md). In this tutorial, communication with the model is via gRPC calls.
