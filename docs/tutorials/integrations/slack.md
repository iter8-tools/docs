...
In this example, you will run the [Your first performance testing](../../getting-started/first-performance.md) but at the end of the experiment, Iter8 will send a message on Slack. 
